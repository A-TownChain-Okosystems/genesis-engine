...
pub enum ProductionFailure { InvalidRecipe, MissingIngredient, WrongStation, StationCapacity, MissingTechnology, MissingTool, ToolBroken, OutputBlocked, AlreadyCompleted }
